...
//second assignment
// let getBooksInYear = req.body.year;
// let allBooks= await BookModel.find({publishing_year : getBooksInYear})

//third assignment
// let data = req.body;
// let {bookName,publishing_year}=data
// let filter = {}
// if(bookName){
//     filter = {bookName}
// }
...
//fourth assignment
//let allBooks= await bookModel.find({indianPrice:{$gt: 1000, $lt: 2000}})

//fifth assignment
// let allBooks = await BookModel.find( { 
//         $or: [ {stocks : true } , { pages: {$gt:  500} }]})
